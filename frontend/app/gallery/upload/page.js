  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/process-images`,
        formData,
        {
          headers: {
        ...
        {images.map((img, index) => (
          ...
          >
            ...
            >
              ...
              <button onClick={() => handleResizeButtonClick(img, index)}>
                Resize
              </button>
            </div>
              ...
              <div>
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleResizeInputChange(index, "width", e.target.value)
                    }
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleResizeInputChange(index, "height", e.target.value)
                    }
                    style={{ width: "70px", color: "black" }}
                  />
                </label>
